...
"#,
        ...
        EnsoCmd::Register { capabilities } => {
            ...
            let enso = tokio::task::block_in_place(|| {
                tokio::runtime::Handle::current()
                    .block_on(EnsoClient::new(config))
        ...
        EnsoCmd::Pay { contract_id } => {
            ...
            println!("  dfx canister call {} submit_arli_payment \\", "7yv6j-ryaaa-aaaaa-qhheq-cai");
        ...
        EnsoCmd::Oracle => {
            ...
            println!("  Contracts: {:?}", arli_core::enso::oracle::load_contracts_from_env());
            println!("  Press Ctrl+C to stop.");
